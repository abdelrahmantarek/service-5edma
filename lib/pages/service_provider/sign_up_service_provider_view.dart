            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("دعنا نبداء في التسجيل !",style: TextStyle(
                      color: Colors.black,
                      fontSize: 20.sp,
                      height: 0.80,
                  ...
                  const Text("يجب عليك تسجيل بيانات بحكمة لانك مقدم خدمة وسوف تتلقى طلبات من اشخاص في كل مكان",style: TextStyle(
                      color: Colors.grey
                  ),),
                  ...
                  const Text("برجاء تحديد بعض الصور من اعمالك السابقة ليتحمس بعض الزوار من طلبك عند الخدمة",style: TextStyle(
                      color: Colors.grey
                  ),),
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      child: Obx((){
                        return controller.loading.value ? const LoadingButton() :  Text("تسجيل جديد".toUpperCase(),style: TextStyle(
                            color: Colors.white,
                            fontSize: 10.5.sp,
                            fontWeight: FontWeight.w800,
                            letterSpacing: 0
